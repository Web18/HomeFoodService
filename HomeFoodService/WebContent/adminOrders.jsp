...
<%
	...
	String[] order = null;
		...
		order_list = OrderDAO.getAdminOrders();
...
<body>
	<div class="container container-style">
		<div class="container-fluid">
				...
				<table class="table">
					...
					<%String  orderId = o.getOrderId();%>
						<tr>
							...
							<td><%=o.getStage()%></td>
							<td><a href="order_details.jsp?oid=<%=orderId%>" class="btn btn-lg pull-right">Open</a></td>
							<td><a href="" class="btn btn-lg pull-right">Change Status</a></td>				
						</tr>
			<%} %>
				</table>	
			</div>			
			<div class="row">
				<div class="col-md-12">
					<a href="admin.jsp" class="btn btn-warning btn-lg pull-right">Go Back</a>
				</div>
			</div>
		</div>
	</div>
