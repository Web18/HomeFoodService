...
public class ProductBean implements Comparable<ProductBean>
{
	...
	public ProductBean(String id, String category, String image,String name, String ingredients,
	...
	public String getPriceOutLocale(String lng) {
		java.text.NumberFormat formatFrench = java.text.NumberFormat.getCurrencyInstance(new Locale("fr", "FR"));
		java.text.NumberFormat formatCanada = java.text.NumberFormat.getCurrencyInstance(new Locale("en", "CA"));
		String priceOut = "";
		if(lng.equals("fr")){
			priceOut = formatFrench.format(this.price);
		}
